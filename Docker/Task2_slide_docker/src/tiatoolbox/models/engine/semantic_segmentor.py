...
class SemanticSegmentor:
    ...
    def __init__(
        ...
        model: list |torch.nn.Module | None = None,
        ...
        *,
        ...
        #self.models = model
        #self.model = model[0]  # original copy
    ...
    def get_reader(
        ...
        *,
        ...
        img_path = Path(img_path)
        image_np= tifi.imread(img_path)         
        reader = WSIReader.open(image_np)         
    ...
    def predict(  # noqa: PLR0913
        ...
        *,
        ...
        self._on_gpu = on_gpu
        if self.model_list:
            self._model = [misc.model_to(model=i, on_gpu=on_gpu) for i in self.models]
        else:
