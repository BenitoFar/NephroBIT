        ...
        if (epoch + 1) % cfg['training']['val_interval'] == 0:
            ...
            with torch.no_grad():
                ...
                for idx_val, val_data in enumerate(val_loader):
                    ...
                    sw_batch_size = 1 #cfg['preprocessing']['sw_batch_size']
                    ...
                    if (idx_val in val_indexes) and (epoch + 1) % 4 == 0:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", help="configuration file", default="config_train_Unet.yaml")
